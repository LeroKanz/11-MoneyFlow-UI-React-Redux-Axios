...
import { getAllLookUps } from '../../redux/lookUpSlice';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const lookUp = await axios.get('/LookUp');
      dispatch(getAllLookUps(lookUp?.data));
  ...
  return (
    <section className={classes.auth}>
      ...
      <form>
        ...
        <Button onClick={handleSubmit} disabled={submit} text='Login'/>
      </form>
    </section>
  );
};
